...
const headCoach = document.getElementById("manager");
...
const {team, sport, year, players} = myFavoriteBaseballTeam;
const {managerName} = myFavoriteBaseballTeam.headCoach;

teamName.textContent = team;
typeOfSport.textContent = sport;
worldSeriesYear.textContent = year;
headCoach.textContent = managerName;
